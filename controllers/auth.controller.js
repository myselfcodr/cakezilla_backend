...
export const sendVerificationToken = asyncHandler(async (req, res) => {
  ...
  if (user.isVerified) throw new CustomError("You already verified", 400);
 ...
 * @parameters userID(id), verify_email_token
 * @returns User Object
 ******************************************************/
export const verifyAccount = asyncHandler(async (req, res) => {
  const { id, verify_email_token } = req.body;
  if (!(id?.length === 24 && verify_email_token))
